...
function ContaContent() {
  ...
  // Handle error returned from Google OAuth callback
  React.useEffect(() => {
                    ...
                    {tab === "login" ? (
                      <motion.form key="login" initial={{ opacity: 0, x: -16 }} animate={{ opacity: 1, x: 0 }}
                        ...
                        <button
                          ...
                          className="w-full flex items-center justify-center gap-3 py-3.5 px-4 border border-neutral-200 rounded-xl text-sm font-medium text-neutral-700 bg-white hover:bg-neutral-50 hover:border-neutral-300 transition-all duration-200 shadow-sm"
                        >
                        ...
                        <div className="relative flex items-center gap-3">
                          ...
                          <span className="text-[11px] text-neutral-400 uppercase tracking-widest font-medium">ou</span>
                          <div className="flex-1 border-t border-neutral-200" />
                        </div>
                        <div className="space-y-1.5">
